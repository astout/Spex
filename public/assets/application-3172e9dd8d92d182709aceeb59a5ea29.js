...
(function() {
  var bottomEPRs, clearSelectedEPRs, closeAllEPRforms, do_selectize, downEPRs, getEntitysProperties, selectize_all, toggleEPRform, toggleEPRselect, topEPRs, upEPRs, validateClearButton, validateEPRselection;
  ...
  $(function() {
    if ($('body').hasClass("hub")) {
      ...
      $("body").on("click", "button.epr-text-append", function(e) {
        var _text, _value;
        if (!$(this).hasClass("disabled")) {
          _value = $("textarea#" + this.id + ".epr-value").val();
          if (_value.length > 0) {
      ...
      return $("body").on("click", "button.epr-evaluate", function(e) {
