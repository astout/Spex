...
(function() {
  var clearEntityAttributes, clearSelectedEntity, deleteEntity, getEntityParams, toggleEntitySelect, validateEntitySelection;
...
(function() {
  var clearPropertyAttributes, clearSelectedProperties, deleteProperties, getPropertyParams, togglePropertySelect, validatePropertySelection;
...
(function() {
  var clearGroupAttributes, clearSelectedGroups, deleteGroups, getGroupParams, toggleGroupSelect, validateGroupSelection;
...
(function() {
  ...
  $(function() {
    ...
    return $("body").on("click", '.table tr.entity_property_relationship', function(e) {
...
(function() {
  var addPropertiesToGroup, clearSelectedGroupsProperties, getGroupsProperties, toggleGroupPropertySelect, validateAddPropertiesToGroup, validateGroupsPropertySelection;
  ...
  $(function() {
    ...
    return $("body").on("click", "#add-selected-properties", function(e) {
      if ($(this).hasClass("enabled")) {
