...
(function() {
  ...
  clearSelectedEntity = function() {
    ...
    return getEntitysGroups(window.selected_entity);
  };
...
(function() {
  var addGroupsToEntity, bottomEntityGroupRelations, clearSelectedEntitysGroups, deleteEntityGroupRelations, downEntityGroupRelations, getEntitysGroups, toggleEntitysGroupSelect, topEntityGroupRelations, upEntityGroupRelations, validateAddGroupsToEntity, validateEntitysGroupSelection;
  ...
  validateEntitysGroupSelection = function() {
    ...
    if (orders.length < 1) {
      ...
      if (!valid) {
        ...
        $("div#down-selected-entitys-groups").addClass("disabled");
        $("div#bottom-selected-entitys-groups").removeClass("enabled");
        return $("div#bottom-selected-entitys-groups").addClass("disabled");
      } else {
        ...
        return $("div#bottom-selected-entitys-groups").addClass("enabled");
      }
    }
  };
  ...
  clearSelectedEntitysGroups = function() {
    window.selected_egrs = [];
    window.selected_entity_group_orders = [];
    return $("tr.selected-entitys-group").removeClass("selected-entitys-group");
  };
...
(function() {
  var getEntitysProperties, toggleEPRselect, validateEPRselection;
  ...
  $(function() {
    $("body").on("click", '.table tr.epr', function(e) {
      return toggleEPRselect(this.id, $(this).data().order);
    });
    return $("td[id^=edit-epr]").on("click", "a", function(e) {
      alert("hello?");
      return e.preventDefault();
    });
  });

  toggleEPRselect = function(id, order) {
    var index;
    id += "";
...
(function() {
  var addPropertiesToGroup, bottomGroupPropertyRelations, clearSelectedGroupsProperties, deleteGroupPropertyRelations, downGroupPropertyRelations, getGroupsProperties, toggleGroupPropertySelect, topGroupPropertyRelations, upGroupPropertyRelations, validateAddPropertiesToGroup, validateGroupsPropertySelection;
  ...
  $(function() {
    ...
    $("body").on("click", "#delete-selected-groups-properties", function(e) {
      if (!$(this).hasClass("disabled")) {
        return deleteGroupPropertyRelations(window.selected_gprs);
      }
    });
    $("body").on("click", "#top-selected-groups-properties", function(e) {
      if (!$(this).hasClass("disabled")) {
        return topGroupPropertyRelations(window.selected_gprs);
      }
    });
    $("body").on("click", "#up-selected-groups-properties", function(e) {
      if (!$(this).hasClass("disabled")) {
        return upGroupPropertyRelations(window.selected_gprs);
      }
    });
    $("body").on("click", "#down-selected-groups-properties", function(e) {
      if (!$(this).hasClass("disabled")) {
        return downGroupPropertyRelations(window.selected_gprs);
      }
    });
    return $("body").on("click", "#bottom-selected-groups-properties", function(e) {
      if (!$(this).hasClass("disabled")) {
        return bottomGroupPropertyRelations(window.selected_gprs);
      }
    });
  });
  ...
  deleteGroupPropertyRelations = function(relationship_ids) {
    var params;
    params = $.param({
  ...
  topGroupPropertyRelations = function(relationship_ids) {
    var params;
    params = $.param({
      selected_gprs: relationship_ids,
      selected_groups: window.selected_groups
  ...
  bottomGroupPropertyRelations = function(relationship_ids) {
    var params;
    params = $.param({
      selected_gprs: relationship_ids,
      selected_groups: window.selected_groups
  ...
  upGroupPropertyRelations = function(relationship_ids) {
    var params;
    params = $.param({
      selected_gprs: relationship_ids,
      selected_groups: window.selected_groups
  ...
  downGroupPropertyRelations = function(relationship_ids) {
    var params;
    params = $.param({
      selected_gprs: relationship_ids,
      selected_groups: window.selected_groups
...
(function() {
  ...
  persistStyling = function() {
    var group, property, relationship_id, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref, _ref1, _ref2, _ref3, _results;
    ...
    if (window.selected_gprs.length > 0) {
      ...
      for (_l = 0, _len3 = _ref3.length; _l < _len3; _l++) {
        ...
        _results.push($("tr#" + relationship_id + ".group_property_relationship").addClass("selected-groups-property"));
      }
      return _results;
    } else {
      return $("tr.selected-groups-property").removeClass("selected-groups-property");
    }
  };
