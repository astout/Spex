...
(function() {
  var bottomEPRs, clearSelectedEPRs, downEPRs, getEntitysProperties, toggleEPRselect, topEPRs, upEPRs, validateEPRselection;
  ...
  $(function() {
    ...
    $("td[id^=edit-epr]").on("click", "a", function(e) {
      alert("hello?");
      return e.preventDefault();
    });
