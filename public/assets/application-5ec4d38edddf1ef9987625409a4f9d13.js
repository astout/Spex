...
(function() {
  var bottomEPRs, clearSelectedEPRs, closeAllEPRforms, do_selectize, downEPRs, getEntitysProperties, toggleEPRform, toggleEPRselect, topEPRs, upEPRs, validateClearButton, validateEPRselection;
  ...
  do_selectize = function() {
    console.log("selectize");
    $("input.epr-function").tokenInput('/entity_property_relationships.json', {
      crossDomain: false,
      theme: "facebook",
      resultsFormatter: function(item) {
        return "<li><img src='https://lh4.googleusercontent.com/-YMVczJiCDjg/AAAAAAAAAAI/AAAAAAAAAFc/QxlloX2rxxk/photo.jpg' style='width:50px'>" + item.name + "</li>";
      },
      tokenFormatter: function(item) {
        return "<li><img src='https://lh4.googleusercontent.com/-YMVczJiCDjg/AAAAAAAAAAI/AAAAAAAAAFc/QxlloX2rxxk/photo.jpg' style='width:10px'>" + item.name + "</li>";
      },
