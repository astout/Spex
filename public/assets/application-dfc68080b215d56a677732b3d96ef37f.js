...
(function() {
  var NewEntityValidation, invalid, valid;
  ...
  valid = function() {
    ...
    return $("input[type=submit]#create-entity").removeClass('disabled');
  };

  invalid = function() {
    return $("input[type=submit]#create-entity").addClass('disabled');
  };
...
(function() {
  var addGroupsToEntity, bottomEntityGroupRelations, clearSelectedEGRs, deleteEntityGroupRelations, downEntityGroupRelations, getEGRs, toggleEGRselect, topEntityGroupRelations, upEntityGroupRelations, validateAddGroupsToEntity, validateEGRselection;
  ...
  $(function() {
    if ($('body').hasClass("hub")) {
      ...
      $("body").on("click", "#clear-selected-egrs", function(e) {
        if (!$(this).hasClass("disabled")) {
          clearSelectedEGRs();
          return validateEGRselection();
        }
      });
      $("body").on("click", "#delete-selected-egrs", function(e) {
        if (!$(this).hasClass("disabled")) {
          return deleteEntityGroupRelations(window.selected_egrs);
        }
      });
      $("body").on("click", "#top-selected-egrs", function(e) {
        if (!$(this).hasClass("disabled")) {
          return topEntityGroupRelations(window.selected_egrs);
        }
      });
      $("body").on("click", "#up-selected-egrs", function(e) {
        if (!$(this).hasClass("disabled")) {
          return upEntityGroupRelations(window.selected_egrs);
        }
      });
      $("body").on("click", "#down-selected-egrs", function(e) {
        if (!$(this).hasClass("disabled")) {
          return downEntityGroupRelations(window.selected_egrs);
        }
      });
      return $("body").on("click", "#bottom-selected-egrs", function(e) {
        if (!$(this).hasClass("disabled")) {
...
(function() {
  var bottomEPRs, clearFormula, clearSelectedEPRs, closeAllEPRforms, determineTypes, do_selectize, downEPRs, getEntitysProperties, getValueType, selectize_all, toggleEPRform, toggleEPRselect, topEPRs, upEPRs, validateClearButton, validateEPRselection, visualize;
  ...
  $(function() {
    ...
    if ($('body').hasClass("hub")) {
      ...
      $("body").on("click", "#clear-selected-eprs", function(e) {
        if (!$(this).hasClass("disabled")) {
          closeAllEPRforms();
          return clearSelectedEPRs();
        }
      });
      $("body").on("input", "input.epr-formula", function(e) {
        return visualize(this);
      });
      $("body").on("click", "button.epr-value-type", function(e) {
        if ($(this).hasClass("selected")) {
          return false;
        } else {
          console.log(this.id);
          clearFormula(this.id);
          $("button#" + this.id + ".epr-value-type").removeClass("selected");
          $(this).addClass("selected");
          if ($(this).hasClass("type-ref")) {
      ...
      $("body").on("click", "button.epr-append", function(e) {
        if (!$(this).hasClass("disabled")) {
          $("input#" + this.id + ".epr-value").val($("input#" + this.id + ".epr-value").val() + $("input#" + this.id + ".epr-formula").val());
          $("input#" + this.id + ".epr-formula").val("");
        }
        e.preventDefault();
        return false;
      });
      return formula_html = $("div");
    }
  });

  visualize = function(element) {
    console.log(element);
    if (getValueType(element.id) === "text") {
      if ($(element).val().length > 0) {
        return $("button#" + element.id + ".epr-append").removeClass("disabled");
      } else {
        return $("button#" + element.id + ".epr-append").addClass("disabled");
      }
    }
  };
    ...
    return $(element).selectize({
      ...
      render: {
        option: function(item, escape) {
          return "<div><img src='https://lh4.googleusercontent.com/-YMVczJiCDjg/AAAAAAAAAAI/AAAAAAAAAFc/QxlloX2rxxk/photo.jpg' style='width: 40px'>" + escape(item.name) + "</div>";
        }
      },
      optgroups: [
        {
      ...
      optgroupField: 'class',
      optgroupOrder: ['Entity', 'Group', 'Property'],
      create: false,
      load: function(query, callback) {
        ...
        if (!query.length) {
          ...
          types = determineTypes(this.getValue());
          return $.ajax({
            url: '/hub/selectize',
            type: 'GET',
            dataType: 'json',
      ...
      onChange: function() {
        var o, types, _i, _len, _ref, _results;
        console.log("changed selectize");
        console.log(this);
        types = determineTypes(this.getValue());
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          o = _ref[_i];
          if (o.indexOf("E") > -1 && !types.e) {
            _results.push(this.removeOption(o));
          } else if (o.indexOf("G") > -1 && !types.g) {
            _results.push(this.removeOption(o));
          } else if (o.indexOf("P") > -1 && !types.p) {
            _results.push(this.removeOption(o));
          } else {
            continue;
          }
  ...
  do_selectize = function(_model) {
    return $(".epr-ref-" + _model).select2({
      ...
      formatResult: function(item) {
        return "<div><img src='https://lh4.googleusercontent.com/-YMVczJiCDjg/AAAAAAAAAAI/AAAAAAAAAFc/QxlloX2rxxk/photo.jpg' style='width: 40px'>" + item.name + "</div>";
      }
    });
  };

  determineTypes = function(value) {
    var types, v, values, _i, _len;
    types = {
      e: true,
      g: true,
      p: true
  ...
  clearFormula = function(id) {
    return $("input#" + id + ".epr-formula").val("");
  };

  getValueType = function(id) {
    if ($("button#" + id + ".type-ref").hasClass("selected")) {
      return "ref";
    } else {
      return "text";
    }
...
(function() {
  ...
  $(function() {
    if ($("form#new_property").length > 0) {
      $("input#property_name, input#property_default_label, input#property_units, input#property_units_short, input#property_default_value, input#property_default_visibility").on("input", function() {
  ...
  NewPropertyValidation = function() {
    var label, name, rx, units, units_short, value, visibility, _valid;
    ...
    if (rx.test(visibility.trim())) {
      if (!$("span#property_default_visibility").hasClass("valid")) {
  ...
  valid = function() {
    $("span#property_name, span#property_units, span#property_default_label, span#property_default_value, span#property_units_short, span#property_default_visibility").addClass("valid");
