...
(function() {
  var addGroupsToEntity, bottomEntityGroupRelations, clearSelectedEntity, clearSelectedEntitysGroups, clearSelectedGroups, clearSelectedProperties, deleteEntity, deleteEntityGroupRelations, deleteGroups, deleteProperties, downEntityGroupRelations, getEntitysGroups, getGroupsProperties, hubAlert, persistStyling, toggleEntitySelect, toggleEntitysGroupSelect, toggleGroupSelect, togglePropertySelect, topEntityGroupRelations, upEntityGroupRelations, validateAddGroupsToEntity, validateAddPropertiesToGroup, validateEntitySelection, validateEntitysGroupSelection, validateGroupSelection, validatePropertySelection;
  ...
  $(function() {
    ...
    $('#properties').on('click', "th a", function(e) {
      window.group_sort = getParameterByName("property_sort", this.href);
      window.group_direction = getParameterByName("property_direction", this.href);
      $.getScript(this.href);
      return false;
    });
    ...
    $("body").on("click", "#add-selected-properties", function(e) {
      if ($(this).hasClass("enabled")) {
        return addPropertiesToGroups(window.selected_properties, window.selected_groups);
      }
    });
  ...
  validateAddPropertiesToGroup = function() {
    if (window.selected_properties.length > 0 && window.selected_groups.length > 0) {
  ...
  getEntitysGroups = function(id) {
    var params;
    console.log("called entitys groups");
    params = $.param({
      selected_entity: id,
      wtf: "test",
      selected_groups: window.selected_groups,
  ...
  getGroupsProperties = function(ids) {
    ...
    params = $.param({
      ...
      properties_search: $("input#property_search_field").val(),
      property_direction: window.property_direction,
      property_sort: window.property_sort
    });
    $;
