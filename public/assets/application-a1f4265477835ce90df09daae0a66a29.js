  ...
  $.TokenList = function (input, url_or_data, settings) {
      ...
      var input_box = $("<input type=\"text\" autocomplete=\"off\" autocapitalize=\"off\"/>")
          ...
          .focus(function () {
              ...
              if (($(input).data("settings").tokenLimit === null || $(input).data("settings").tokenLimit !== token_count) && $(input).data("settings").engaged ) {
                  show_dropdown_hint();
              }
          ...
          .keyup(function (event) {
              ...
              {
                var _input = $(this).val();
                // rx = new RegExp($(input).data("settings").tokenDelimiter)
                var _del = $(input).data("settings").tokenDelimiter;

                var _engage = $(input).data("settings").tokenEngager
                var _disengage = $(input).data("settings").tokenDisengager

                toggleEngaged(engageTest(_input, _engage, _disengage));

                if(_input.lastIndexOf(_del) == _input.length-_del.length || _input.lastIndexOf(_engage) == _input.length-_engage.length)
                {
      ...
      function toggleEngaged(engage)
      {
        if (typeof engage === 'boolean') {
            $(input).data("settings").engaged = engage
        } else {
            $(input).data("settings").engaged = !$(input).data("settings").engaged;
        }
        // if there is any token selected we deselect it
        if(selected_token) {
            deselect_token($(selected_token), POSITION.END);
      ...
      function isEngaged()
      {
        return $(input).data("settings").engaged
      }
      ...
      function add_freetagging_tokens() {
          ...
          {
            tokens = value.split($(input).data("settings").tokenEngager);
          }
      ...
      //true if the plugin should be engaged, false otherwise
      //tests the str for text surrounded by the engaging strings.
      function engageTest(str, engage, disengage)
      {
        if(isEngaged())
        {
          var rx = new RegExp(escapeRegExp(disengage));
          return !rx.test(str);
        }
        else
        {
          var rx = new RegExp(escapeRegExp(engage));
          return rx.test(str);
        }
      }
...
(function() {
  var addGroupsToEntity, clearSelectedEGRs, egrLoad, egrPagination, egrRefresh, egr_query, get_egr_params, toggleEGRselect, validateAddGroupsToEntity, validateEGRselection;
  ...
  $(function() {
    if ($('body').hasClass("entity_group_relationships")) {
      ...
      $("body").on("click", "div.egr.clear-selection", function(e) {
        if (!$(this).hasClass("disabled")) {
          clearSelectedEGRs();
          return validateEGRselection();
        }
      });
      $("body").on("click", "div.egr.delete-selection", function(e) {
        if (!$(this).hasClass("disabled")) {
          return deleteEntityGroupRelations(window.selected_egrs);
        }
      });
      $("body").on("click", "div.btn.egr.view", function(e) {
        if (!$(this).hasClass("disabled")) {
          return Turbolinks.visit("/entity_group_relationships/" + window.selected_egrs[0] + "/edit");
        }
      });
      return egrLoad();
    }
  ...
  validateEGRselection = function() {
    ...
    if (positions.length < 1) {
      ...
      if (!valid) {
        ...
        $("div#down-selected-egrs").addClass("disabled");
        $("div#bottom-selected-egrs").removeClass("enabled");
        return $("div#bottom-selected-egrs").addClass("disabled");
      } else {
        ...
        return $("div#bottom-selected-egrs").addClass("enabled");
      }
    }
  };
  ...
  egr_query = function() {
    ...
    return $.get("egr_query?" + params);
  };

  window.egr_query = egr_query;

  egrPagination = function() {
    console.log("ajaxifying egr pagination");
    return $("div#egr_list > .pagination").on("click", 'a', function(e) {
  ...
  egrLoad = function() {
    egrPagination();
    return $("body").on('input', "input#egr_search_field", function(e) {
      window.egr_page = "1";
      egr_query();
      return false;
    });
...
(function() {
  var do_selectize, selectize_all;

  $(function() {
    $("body").on("input", "input.epr-formula-text", function(e) {
      var _text;
      _text = $(this).val();
      if (_text.length > 0) {
        return $("button#" + this.id + ".epr-text-append").removeClass("disabled");
      } else {
        return $("button#" + this.id + ".epr-text-append").addClass("disabled");
      }
    });
    $("body").on("click", "button.epr-text-append", function(e) {
      var _text, _value;
      if (!$(this).hasClass("disabled")) {
    ...
    $("body").on("click", "button.epr-ref-append", function(e) {
      var _text, _value;
      if (!$(this).hasClass("disabled")) {
        _value = $("textarea#" + this.id + ".epr-value").val().trim();
        _text = "";
    ...
    $("body").on("click", "button.epr-evaluate", function(e) {
  ...
  selectize_all = function() {
    ...
    return $("select.epr-roles").select2({
  ...
  do_selectize = function(_model) {
    ...
    if (_model === "property") {
      ...
      $("select.epr-ref-property").on("change", function(e) {
        var _val;
    ...
    if (_model === "group") {
      ...
      $("select.epr-ref-group").on("change", function(e) {
        var params;
    ...
    if (_model === "entity") {
      ...
      $("select.epr-ref-entity").on("change", function(e) {
        var params;
        console.log("epr id: " + this.id);
        try {
    ...
    return $("button.epr-ref-" + _model).on("click", function(e) {
...
(function() {
  var closeAllOpenForms, delay, hideDisabledFields, openTrueValue, registerHiddenRows;
  ...
  $(function() {
    if ($("body").hasClass("report")) {
      ...
      return $("body").on("click", "span#print_view", function(e) {
  ...
  openTrueValue = function(element) {
    ...
    if (openForm) {
      ...
      return $('#' + id + ".trueValue").delay(300).slideUp();
    } else {
      ...
      id = element.id;
      return $('#' + id + '.trueValue').slideDown();
    }
  };

  closeAllOpenForms = function() {
    $(".openForm").removeClass("openForm");
    return $(".trueValue").slideUp();
  };

  window.closeAllOpenForms = closeAllOpenForms;

  hideDisabledFields = function() {
  ...
  registerHiddenRows = function() {
    $(".trueValue").hide();
    return $("body").on("click", "a.editable.trigger", function(e) {
      openTrueValue(this);
      e.preventDefault();
      return false;
    });
...
(function() {
  var NewEntityValidation, clearEntityAttributes, clearSelectedEntity, deleteModal, entityPagination, entityQuery, get_entity_params, invalid, toggleEntitySelect, valid, validateEntitySelection;
  ...
  $(function() {
    if ($("body").hasClass("entities")) {
      ...
      $('div.entities.list').on('click', "th a", function(e) {
      ...
      $("body").on("click", "div.entity.clear-selection", function(e) {
        if (!$(this).hasClass("disabled")) {
          return clearSelectedEntity();
        }
      });
      $("body").on("click", "div.entity.delete-selection", function(e) {
        if (!$(this).hasClass("disabled")) {
          deleteModal(window.selected_entity);
          return console.log("delete btn clicked");
        }
      });
      $("body").on("click", "div.btn.entity.view", function(e) {
        if (!$(this).hasClass("disabled")) {
          return Turbolinks.visit("entities/" + window.selected_entity);
        }
      });
      ...
      $("body").on("click", "span.entity.delete", function(e) {
        deleteModal(this.id);
  ...
  entityQuery = function() {
    ...
    return $.get("entity_query?" + params);
  };
  ...
  toggleEntitySelect = function(id) {
    ...
    if (window.selected_entity === id) {
      ...
      egr_query();
      return validateEntitySelection();
    }
  };
  ...
  validateEntitySelection = function() {
    var _html;
    ...
    return validateAddGroupsToEntity();
  };
...
(function() {
  var clearSelectedEPRs, closeAllEPRforms, eprLoad, eprPagination, eprRefresh, epr_query, get_epr_params, moveEPRs, toggleEPRform, toggleEPRselect, validateClearButton, validateEPRselection;

  $(function() {
    if ($('body').hasClass("epr_query" || $('body').hasClass("hub"))) {
      window.epr_page = "1";
  ...
  window.get_epr_params = get_epr_params;

  epr_query = function() {
    var params;
    params = get_epr_params();
    return $.get("epr_query?" + params);
  };

  window.epr_query = epr_query;

  eprPagination = function() {
    console.log("ajaxifying epr pagination");
    return $("div#epr_list > .pagination").on("click", 'a', function(e) {
      console.log("epr page link clicked");
      e.preventDefault();
      window.epr_page = getParameterByName("epr_page", this.href) || "1";
      epr_query();
      return false;
    });
  };

  window.eprPagination = eprPagination;
  ...
  eprLoad = function() {
    ...
    $("body").on("click", "#down-selected-eprs", function(e) {
      if (!$(this).hasClass("disabled")) {
        return moveEPRs("down");
      }
    });
    $("body").on("click", "#bottom-selected-eprs", function(e) {
      if (!$(this).hasClass("disabled")) {
        return moveEPRs("bottom");
      }
    });
    return $("body").on("click", "#clear-selected-eprs", function(e) {
      if (!$(this).hasClass("disabled")) {
        closeAllEPRforms();
        return clearSelectedEPRs();
      }
  ...
  eprRefresh = function() {
    eprPagination();
    return $("body").on('input', "input#epr_search_field", function(e) {
      epr_query();
      return false;
    });
  };

  window.eprRefresh = eprRefresh;
  ...
  toggleEPRform = function(element) {
    ...
    if (openForm) {
      id = element.id;
      $(element).removeClass('openForm');
      return $('#' + id + ".edit-epr-form").animate({
        height: 'toggle',
        opacity: 'toggle'
      }, 'slow');
    } else {
  ...
  closeAllEPRforms = function() {
    var element, open, _i, _len;
    open = $('td.edit-epr-trigger.openForm');
    for (_i = 0, _len = open.length; _i < _len; _i++) {
      element = open[_i];
      $("#" + element.id + ".edit-epr-form").animate({
        height: 'toggle',
        opacity: 'toggle'
      }, 'slow');
    }
    return open.removeClass('openForm');
  };
  ...
  validateClearButton = function() {
    var open;
    open = $("td.edit-epr-trigger.openForm");
    if (window.selected_eprs.length > 0 && window.selected_egrs.length === 1 || open.length > 0) {
      return $("#clear-selected-eprs").removeClass("disabled");
    } else {
      return $("#clear-selected-eprs").addClass("disabled");
    }
  };
...
(function() {
  ...
  NewGroupValidation = function() {
    ...
    if (!$("span#group_label").hasClass("valid")) {
      return $("span#group_label").addClass("valid");
    }
  };
...
(function() {
  ...
  validatePropertySelection = function() {
...
(function() {
  ...
  $(function() {
    if ($('body').hasClass("hub")) {
      ...
      $("body").on("click", "#add-selected-properties", function(e) {
        if ($(this).hasClass("enabled")) {
          return createGPRs(window.selected_properties, window.selected_groups);
        }
      });
  ...
  createGPRs = function(properties, group) {
    var params;
    params = $.param({
      selected_groups: window.selected_groups,
      selected_properties: window.selected_properties,
...
(function() {
  var ajaxPagination, getAllParams, hub, hubAlert, persistStyling, toggleChevron;
  ...
  hubAlert = function(documentId, html) {
    $("#hub-alert").html("");
    $("#entity-alert1").html("");
    $("#entity-alert2").html("");
    $("#group-alert1").html("");
...
(function() {
  ...
  $(function() {
    ...
    $("body").on("click", "button.property.calculator", function(e) {
      var _value;
      console.log("id: " + this.id + " button: " + this.innerText + " value: " + this.value);
    ...
    return $("body").on("click", "button#new.property.copy", function(e) {
      var params, _id;
      e.preventDefault();
  ...
  properties_selectize_all = function() {
    ...
    return $("select.property.copy_from").select2({
...
(function() {
  var NewPropertyValidation, capitalize, capitalizeEachElement, capitalizeFirstElement, deleteModal, get_property_params, invalid, valid;
  ...
  $(function() {
    ...
    if ($("form#new_property").length > 0 || $("form.edit_property").length > 0) {
      ...
      $("body").on("keyup", "input.property.name", function(e) {
        if (e.keyCode === 32) {
      ...
      $("body").on("blur", "input.property.name", function(e) {
        var a, _val;
        if ($("input#" + this.id + ".property.default_label").val().length < 1) {
          ...
          _val = a.join(" ");
          return $("input#" + this.id + ".property.default_label").val(_val);
        }
      });
    }
  ...
  capitalizeFirstElement = function(element, index, array) {
    if (index === 0) {
      return array[index] = capitalize(element);
    }
  };

  capitalizeEachElement = function(element, index, array) {
    var preps;
    preps = ["a", "the", "of", "per"];
...
(function() {
  ...
  $(function() {
    if ($('body').hasClass("roles")) {
      ...
      $("body").on("click", "button.role-bool", function(e) {
        var _id;
        e.preventDefault();
        _id = this.id;
        console.log("id: " + _id);
      ...
      $("body").on("input", "input#role_name", function(e) {
        return validateName($(this).val());
      });
      $("body").on("keydown", "input#role_name", function(e) {
        if (e.keyCode === 13) {
          e.preventDefault();
          return false;
        }
      });
      $("body").on("click", "button.def-change", function(e) {
        var clicked, _false, _true;
        e.preventDefault();
        _true = $("button#true");
        _false = $("button#false");
        clicked = this.id;
      ...
      $("body").on("click", "span.delete", function(e) {
        deleteModal(this.id);
        return console.log("delete role clicked");
      });
      $("body").on("click", "span.default", function(e) {
  ...
  resetDefaultChangeButtons = function() {
    $("div#def-change").html('<button type="button" id="false" class="btn btn-default btn-success btn-sm selected def-change">Don\'t Change</button> <button type="button" id="true" class="btn btn-default btn-sm def-change">Change</button>');
    $("input#role_change_defaults").val("false");
    $("span#final-message").html("WILL NOT BE");
    $("span#final-message").removeClass("alert-danger");
    return $("span#final-message").addClass("alert-success");
  };

  setLabel = function(id) {
    if ($("input#" + id).val() === "true") {
      $("button#" + id).removeClass("btn-default");
      return $("button#" + id).addClass("btn-success");
    } else {
      $("button#" + id).removeClass("btn-success");
      return $("button#" + id).addClass("btn-default");
    }
  };
