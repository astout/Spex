...
(function() {
  var NewPropertyValidation, capitalize, capitalizeFirstElement, deleteModal, get_property_params, invalid, valid;
  ...
  $(function() {
    ...
    if ($("form#new_property").length > 0 || $("form.edit_property").length > 0) {
      ...
      $("body").on("keydown", "input.property.name", function(e) {
        if (e.keyCode === 32) {
          e.preventDefault();
          $(this).val($(this).val() + "_");
